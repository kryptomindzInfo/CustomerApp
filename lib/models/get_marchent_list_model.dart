...
String getMerchantListResponseModelToJson(GetMerchantListResponseModel data) => json.encode(data.toJson());

class GetMerchantListResponseModel {
  GetMerchantListResponseModel({
    this.status,
    this.message,
    this.list,
  });
  ...
  factory GetMerchantListResponseModel.fromJson(Map<String, dynamic> json) => GetMerchantListResponseModel(
    status: json["status"],
