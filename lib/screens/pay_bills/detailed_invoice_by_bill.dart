...
class BillInvoiceDetails extends StatefulWidget {

  final BillInvoice invoices;
  BillInvoiceDetails({this.invoices});

  @override
  _BillInvoiceDetailsState createState() => _BillInvoiceDetailsState();
}

class _BillInvoiceDetailsState extends State<BillInvoiceDetails> {
